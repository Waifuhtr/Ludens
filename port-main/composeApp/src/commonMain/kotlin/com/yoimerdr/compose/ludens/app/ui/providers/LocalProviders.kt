 ...
 * @param cheatPlayer The [CheatPlayer] controller for debug/cheat operations. Injected via
 * Koin with the evaluator as a parameter.
...
fun LocalProviders(
    ...
    cheatPlayer: CheatPlayer = koinInject { parametersOf(evaluator) },
    ...
    CompositionLocalProvider(
        ...
        LocalCheatPlayer provides cheatPlayer,
