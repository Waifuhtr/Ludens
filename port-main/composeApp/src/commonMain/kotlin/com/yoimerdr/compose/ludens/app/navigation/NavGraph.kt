...
import com.yoimerdr.compose.ludens.features.cheats.presentation.screen.CheatsScreen
...
import com.yoimerdr.compose.ludens.features.plugins.presentation.screen.PluginsScreen
...
fun NavGraph(
    ...
    ProvideWebPlugin(
        ...
        NavHost(
            ...
            composable(
                route = Destination.Cheats.route,
                arguments = Destination.Cheats.arguments,
                enterTransition = {
                    fadeIn() + scaleIn(initialScale = 0.965f) + slideInVertically { it / 5 }
                },
                exitTransition = {
            ...
            composable(
                route = Destination.Plugins.route,
                arguments = Destination.Plugins.arguments,
                enterTransition = {
                    fadeIn() + scaleIn(initialScale = 0.965f) + slideInVertically { it / 5 }
                },
                exitTransition = {
    ...
    AnimatedVisibility(
        ...
        ProvideInteractionManager {
            HomeScreen(
                ...
                onLoad = onLoad,
                viewModel = viewModel,
                showControls = currentRoute != null &&
                        !currentRoute.contains(Destination.Settings.route) &&
                        currentRoute != Destination.Cheats.route &&
                        currentRoute != Destination.Plugins.route,
                onRestart = onRestart
            )
        }
    }
