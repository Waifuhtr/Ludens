...
fun LudensClient(
    ...
    LocalProviders(
        ...
        // BackPopup needs to be inside LocalProviders: on the Home screen it forwards the
        // system back press to the game as an Escape/Cancel key via LocalInputPlayer.
        BackPopup(nav)
