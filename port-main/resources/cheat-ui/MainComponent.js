...
<div 
    ...
    created () {
        ...
        // --- Ludens bridge (riaslink.fun) -----------------------------------------
        // This plugin is designed around desktop keyboard shortcuts (Ctrl+C etc.), which
        // don't exist on a touchscreen. This exposes a plain window-level hook so the native
        // Android app can open/close the cheat window from an on-screen button instead.
        window.__ludensAdvancedCheat = {
            toggle: (componentName = null) => this.toggleCheatModal(componentName),
            open: (componentName = null) => this.openCheatModal(componentName),
        }
        // ---------------------------------------------------------------------------
